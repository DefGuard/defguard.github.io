...
image: "public/images/blog/from-2025-to-2026/Futur_2.png"
tags: ["defguard", "roadmap", "2025", "2026", "release", "enterprise vpn", "wireguard", "future plans"]
draft: false
---

![Defguard Year in Review Banner 2025-2026](/images/blog/from-2025-to-2026/Futur_2.png)
...
* [Firewall/ACLs](https://docs.defguard.net/features/access-control-list)
* [Mobile Clients](https://docs.defguard.net/using-defguard-for-end-users/mobile-client)
* [External SSO Multi-Factor Authentication](https://docs.defguard.net/features/external-openid-providers)
* [Desktop Client MFA with Mobile Client Biometry](https://docs.defguard.net/using-defguard-for-end-users/desktop-client/using-multi-factor-authentication-mfa#multi-factor-authentication-via-mobile-biometry)
* [LDAP and Active Directory two-way synchronization](https://docs.defguard.net/features/ldap-and-active-directory-integration/two-way-ldap-and-active-directory-synchronization)
* [Activity Stream and SIEM systems integration](https://docs.defguard.net/features/activity-log)
* [Desktop Clients rewrite for Windows (with wireguardNT) and macOS (with native system VPN extensions)](https://defguard.net/blog/defguard-16-release-notes/)
* [Desktop Clients zero-touch provisioning and enrollment](https://docs.defguard.net/features/desktop-client-auto-provisioning)
